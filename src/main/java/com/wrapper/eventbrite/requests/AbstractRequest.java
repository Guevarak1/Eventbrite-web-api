...
import com.wrapper.eventbrite.EventbriteApi;
...
public abstract class AbstractRequest<T> implements IRequest<T> {
    ...
    protected AbstractRequest(Builder<T, ?> builder) {
        ...
        try {
            ...
            EventbriteApi.LOGGER.log(Level.SEVERE, e.getInput());
        }
    ...
    @Override
    public String getJson() throws IOException, EventbriteWebApiException {
    ...
    public static abstract class Builder<T, BT extends Builder<T, ?>> implements IRequest.Builder<T, BT> {
        ...
        private IHttpManager httpManager = EventbriteApi.DEFAULT_HTTP_MANAGER;
        private String scheme = EventbriteApi.DEFAULT_SCHEME;
        private String host = EventbriteApi.DEFAULT_HOST;
        private Integer port = EventbriteApi.DEFAULT_PORT;
        ...
        public BT setPathParameter(final String name, final String value) {
            ...
            try {
                ...
                EventbriteApi.LOGGER.log(Level.SEVERE, e.getMessage());
            }
